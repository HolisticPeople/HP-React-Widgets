...
## 10. Mandatory Project Documentation
Agents MUST read the following markdown files to understand project-specific implementations, developer guides, and creation protocols:
1. `AI_INSTRUCTIONS.md`: High-level AI coordination for this repository.
2. `SHORTCODES_DEVELOPER_GUIDE.md`: Comprehensive guide for React shortcode architecture and development.
3. `docs/AI_FUNNEL_CREATION.md`: Protocol for building new funnels and components.
4. `docs/FUNNEL_DATA_UPDATE_GUIDE.md`: How to manage and update funnel configurations and ACF data.
5. `docs/MODULAR_FUNNEL_SHORTCODES.md`: Architectural details on the modular shortcode system.
6. `docs/OBSOLETE_FIELDS_REPORT.md`: Reference for deprecated or obsolete fields to avoid.
