...
// USPS Logo - using actual badge (white bg for visibility on dark themes)
export const USPSLogo = () => (
  <img src={USPS_BADGE_BASE64} alt="USPS" width="24" height="24" style={{ objectFit: 'contain', background: 'white', borderRadius: '4px', padding: '2px' }} />
);

// UPS Logo - using actual badge (white bg for consistency)
export const UPSLogo = () => (
  <img src={UPS_BADGE_BASE64} alt="UPS" width="24" height="24" style={{ objectFit: 'contain', background: 'white', borderRadius: '4px', padding: '2px' }} />
);
